...
const VideoPlayer = ({navigation}) => {
  ...
  const handleProgress = data => {
    ...
    if (current > lastRecordedTime + 2) {
      setSkippedSections(prev => [
        ...prev,
        {from: lastRecordedTime, to: current},
      ]);
    }
  ...
  const handleSeek = nativeEvent => {
    ...
    setSkippedSections(prev => [...prev, {from, to}]);
  };
      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View
          style={[
            ...
            {
              width: width * 1,
              height: isLandscape ? height * 0.6 : height * 0.2,
            }, // Responsive size
          ]}>
          <Video
            source={{uri: videoUrl}}
        ...
        <View style={[styles.frameParent, styles.parentFlexBox]}>
          <View style={[styles.ellipseParent, styles.parentFlexBox]}>
            <Image
              ...
              resizeMode="cover"
              source={require('../assets/profilepic9.png')}
            />
        ...
        <View style={styles.videoDescriptionParent}>
          <Text style={[styles.videoDescription, styles.aravindhLayout]}>
            Video Description:
          </Text>
          <Text style={[styles.loremIpsumDolor, styles.kFollowersTypo]}>
            Lorem ipsum dolor sit amet consectetur. Scelerisque scelerisque
            malesuada id consequat purus gravida. Ac velit tristique ultrices a
            vel arcu. Vivamus iaculis pharetra arcu integer pretium porttitor
            maecenas. Ullamcorper tortor et ac ultricies. Id duis laoreet sit
            id. Dictum egestas nec ut at sit nunc nunc nunc velit. Sed viverra
            laoreet viverra ut neque dui amet feugiat.
          </Text>
        </View>
        ...
        <View style={styles.frameParent5}>
          <View style={[styles.frameParent6, styles.alsoViewPosition]}>
            <Text style={[styles.alsoView, styles.alsoViewPosition]}>
              Also view
            </Text>
            ...
            <View style={styles.cardView}>
              <View style={styles.storiesOfVishnuParent}>
                <Text style={[styles.storiesOfVishnu, styles.aravindhTypo]}>
                  Stories of Vishnu
                </Text>
                <Text style={[styles.byAravindh, styles.kFollowersTypo]}>
                  By Aravindh
                </Text>
              </View>
            </View>
