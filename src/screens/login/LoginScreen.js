...
GoogleSignin.configure({
  webClientId:
    '968763437649-9cq1vtnj2ssag10u0hke0mgmjaqn5i4q.apps.googleusercontent.com',
  iosClientId:
    '968763437649-47ue230k96ni2d5shup0d4h213vd6s45.apps.googleusercontent.com',
...
const Login = ({theme = 'light'}) => {
  ...
  const GoogleLogin = async () => {
    try {
      ...
      dispatch(
        googleLogin({userEmail: email, accessToken: idToken, navigation}),
      )
        .unwrap()
        .then(response => {
          ...
          <View style={styles.container}>
            ...
            <View style={styles.formContainer}>
              <Text
                style={[
                  styles.loginText,
                  {fontSize: isTablet ? 22 : 18, color: currentTheme.textColor},
                ]}>
              ...
              <View style={styles.buttonRow}>
                ...
                <Text
                  style={[styles.orText, {color: currentTheme.orTextColor}]}>
                  - or -
                </Text>
