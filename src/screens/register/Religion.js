...
const Religion = ({ theme = "light" }) => {
  ...
  const handleContinue = async () => {
    ...
    if (religion && religion !== "Select Religion") {
      dispatch(setReligion(religion)); // Pass only the string
    }
  
    console.log("Updated Religion:", religionData); // This will log the correct selected value
  
    navigation.navigate("Destination"); // Navigate immediately after dispatching
  };
